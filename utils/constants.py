...
SETUP_SCHEMA = {
    "📢 Channels": [
        {"key": "bot_channel_id", "name": "Bot Channel", "type": "channel", "cmd": "`/setup channel bot <#channel>`"},
        ...
        {"key": "booster_lounge_vc_id", "name": "Booster Lounge VC", "type": "channel", "cmd": "`/setup vc <#channel>`"},
